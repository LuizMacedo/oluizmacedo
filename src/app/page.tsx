...
export default function Home() {
  return (
    <>
        ...
        <Container size="narrow" className="relative z-10">
          <div className="text-center">
            ...
            <p className="mt-4 text-sm text-muted/70 max-w-xl mx-auto">
              Uma trajetória construída ao longo de 20 anos em tecnologia, 12
              deles na Microsoft, entre produto, certificações e contextos
              globais.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="mt-6 space-y-4 text-muted leading-relaxed">
                <p>
                  Senior Product Manager na Microsoft, vivendo no Texas, EUA há
                  quase 10 anos. São 20 anos trabalhando com tecnologia e 12 na
                  Microsoft — uma trajetória que combina engenharia, ownership
                  de conteúdo técnico em escala global e gestão de produto.
                  Poucas pessoas reúnem essas três perspectivas.
                </p>
                <p>
                ...
                <p>
                  ...
                  Tech que querem tomar decisões de carreira com mais contexto —
                  em produto, senioridade e carreira internacional.
                </p>
              </div>
      ...
      <section
        id="programas"
        className="py-20 md:py-28 bg-surface/30 border-t border-border"
      >
        <Container>
          <SectionHeader
            label="Programas"
...
const pillars = [
  {
    ...
    description:
      "Gestão de produto com visão sênior: priorização, discovery, métricas e decisões de negócio.",
  },
  {
    icon: "◈",
    title: "Carreira internacional",
    description:
      "Posicionamento, preparação e contexto para quem quer trabalhar em empresas globais.",
  },
  {
    icon: "⬡",
    title: "Senioridade e influência",
    description:
      "Gestão de stakeholders, comunicação executiva e posicionamento profissional.",
  },
  {
    icon: "◇",
    title: "Clareza e direção profissional",
    description:
      "Diagnóstico de carreira, tomada de decisão e planejamento de próximos passos.",
  },
];
