      ...
      <section className="py-20 md:py-28 border-t border-border">
        <Container size="narrow">
          ...
          <div className="mt-10 space-y-4 text-lg text-muted leading-relaxed">
            <p>
              Um grupo para profissionais de Tech que querem conversar sobre
              carreira com mais seriedade. Não é sobre quantidade de pessoas — é
              sobre a qualidade das conversas e o comprometimento de quem
              participa.
            </p>
            <p>
              Você vai encontrar discussões sobre produto, senioridade, gestão
              de stakeholders, carreira internacional e decisões profissionais —
              com exemplos reais, frameworks aplicáveis e perspectivas de quem
              já viveu essas situações.
            </p>
            <p>
              Facilitado por Luiz Macedo, Senior Product Manager na Microsoft
              com 20 anos em tecnologia, a comunidade combina conteúdos
              exclusivos, encontros ao vivo e trocas diretas entre
              profissionais.
            </p>
          </div>
        </Container>
...
const features = [
  {
    ...
    description:
      "Threads sobre negociação de oferta, posicionamento com liderança, transição de área e decisões de carreira — com experiência prática, não teoria.",
  },
  {
    title: "Encontros ao vivo mensais",
    description:
      "Sessões com temas definidos (ex: como conduzir uma 1:1 produtiva, priorização em produto, preparar-se para promoção) e espaço para perguntas diretas.",
  },
  {
    title: "Networking com profissionais sênior",
    description:
      "Conexão com PMs, engenheiros e líderes de empresas como Microsoft, Google e outras Big Techs que valorizam profundidade.",
  },
  {
    title: "Revisão entre pares",
    description:
      "Espaço para compartilhar currículos, LinkedIn, apresentações e decisões de carreira para feedback honesto e construtivo.",
  },
  {
    title: "Conteúdos exclusivos",
    description:
      "Análises de caso, frameworks aplicados e reflexões sobre produto, senioridade e carreira internacional não publicados em outro lugar.",
  },
  {
    title: "Acompanhamento consistente",
    description:
      "Um ambiente com ritmo e compromisso, não apenas mais um grupo silencioso. Participação ativa é incentivada e valorizada.",
  },
];
