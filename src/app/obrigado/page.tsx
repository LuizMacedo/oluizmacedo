...
export const metadata: Metadata = {
  title: "Obrigado",
  description:
    "Obrigado por entrar em contato ou se inscrever. Luiz Macedo vai retornar em breve.",
      ...
      <Container size="narrow">
        <div className="text-center">
          ...
          <p className="mt-6 text-lg text-muted leading-relaxed max-w-lg mx-auto">
            Obrigado pelo seu interesse. Se for necessário, entro em contato em
            breve. Enquanto isso, fique à vontade para explorar o site.
          </p>
